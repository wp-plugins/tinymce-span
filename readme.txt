...
* Either install the plugin using the WordPress plugin installer in the admin panel, or
* Download the zip file from WordPress.org then upload it to wp-content/plugins and unzip it
...
http://wpservicemasters.com/plugins/tinymce-span/